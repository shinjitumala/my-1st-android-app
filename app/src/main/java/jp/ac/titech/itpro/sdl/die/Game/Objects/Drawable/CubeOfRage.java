...
public class CubeOfRage extends GameDrawableObject {
    public CubeOfRage(int initial_x, int initial_y) {
        ...
        // initialize the cube
        Face top = new Face(GameView.load_image(R.drawable.cor_top));
        Face bottom = new Face(GameView.load_image(R.drawable.cor_bottom));
        Face left = new Face(GameView.load_image(R.drawable.cor_left));
        Face right = new Face(GameView.load_image(R.drawable.cor_right));
        Face up = new Face(GameView.load_image(R.drawable.cor_up));
        Face down = new Face(GameView.load_image(R.drawable.cor_down));
    ...
    private class Face{
        ...
        Face(Drawable image){this.image = image;}
    }
